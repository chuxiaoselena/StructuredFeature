...
void SigmoidCrossEntropyLossMaskLayer<Dtype>::LayerSetUp(
...
template <typename Dtype>
void SigmoidCrossEntropyLossMaskLayer<Dtype>::Reshape(
    const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void SigmoidCrossEntropyLossMaskLayer<Dtype>::Forward_cpu(
    const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
...
#ifdef CPU_ONLY
STUB_GPU_BACKWARD(SigmoidCrossEntropyLossMaskLayer, Backward);
#endif

INSTANTIATE_CLASS(SigmoidCrossEntropyLossMaskLayer);
REGISTER_LAYER_CLASS(SigmoidCrossEntropyLossMask);
