...
template <typename Dtype>
class AccuracyMaskLayer : public Layer<Dtype> {
 public:
  /**
   * @param param provides AccuracyParameter accuracy_param,
   *     with AccuracyLayer options:
   ...
   *     correct if the correct label is among the top 5 predicted labels.
   */
  explicit AccuracyMaskLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
...
////////////////////////////////////////////////////////////////////////
template <typename Dtype>
class SigmoidCrossEntropyLossMaskLayer : public LossLayer<Dtype> {
 public:
  explicit SigmoidCrossEntropyLossMaskLayer(const LayerParameter& param)
      : LossLayer<Dtype>(param),
          sigmoid_layer_(new SigmoidLayer<Dtype>(param)),
          sigmoid_output_(new Blob<Dtype>()) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
//  virtual inline int ExactNumBottomBlobs() const { return 3; }  // input one more bottom
  virtual inline const char* type() const { return "SigmoidCrossEntropyLossMask"; }
  virtual inline int ExactNumBottomBlobs() const { return 3; }
 protected:
  /// @copydoc SigmoidCrossEntropyLossLayer
  virtual void Forward_cpu(const vector<Blob<Dtype>*>& bottom,
...
////////////////////////////////////////////////////////////////////////
template <typename Dtype>
class SigmoidCrossEntropyLossMaskFullLayer : public LossLayer<Dtype> {
 public:
  explicit SigmoidCrossEntropyLossMaskFullLayer(const LayerParameter& param)
      : LossLayer<Dtype>(param),
          sigmoid_layer_(new SigmoidLayer<Dtype>(param)),
          sigmoid_output_(new Blob<Dtype>()) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
//  virtual inline int ExactNumBottomBlobs() const { return 3; }  // input one more bottom
  virtual inline const char* type() const { return "SigmoidCrossEntropyLossMaskFull"; }
  virtual inline int ExactNumBottomBlobs() const { return 3; }
 protected:
  /// @copydoc SigmoidCrossEntropyLossLayer
  virtual void Forward_cpu(const vector<Blob<Dtype>*>& bottom,
...
/*
template <typename Dtype>
class SoftmaxWithLossMaskFullLayer : public LossLayer<Dtype> {
 public:
  explicit SoftmaxWithLossMaskFullLayer(const LayerParameter& param)
      : LossLayer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual inline int ExactNumBottomBlobs() const { return 3; }
  virtual inline const char* type() const { return "SoftmaxWithLossMaskFullLayer"; }////////////////
  virtual inline int ExactNumTopBlobs() const { return -1; }
  virtual inline int MinTopBlobs() const { return 1; }
  virtual inline int MaxTopBlobs() const { return 2; }
